...
#А тут ми вираховуємо кількість продуктів яка лежить в кошику покупця
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(to=Products, on_delete=models.SET_DEFAULT, verbose_name="Продукт", null=True, default=None)
